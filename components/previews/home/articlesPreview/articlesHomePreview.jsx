...
function ArticleHomePreview({ article }) {
  return(<div className="flex tablet:w-1/3 flex-col gap-2 items-center items-stretch">
    ...
    <div className="flex flex-col justify-center">
      <a href={article.link} className="text-2xl block text-center">{article.title}</a>
